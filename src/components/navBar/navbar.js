    ...
    <div id="container-nav">
      ...
      <div id="bottom-nav">
        <span id="user-box">
          <img
            id="person"
            src="https://avatars.githubusercontent.com/u/147831307?s=400&u=06e4936bb9fa83f24285708ca36d887441679579&v=4"
            alt="profile"
          />
          <span>
            <p id="name">ruben lubasa</p>
            <p id="id">@Arubenlubasa</p>
          </span>
        </span>
